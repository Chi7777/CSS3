    $(document).ready(function() {
        ...
        for (i = 0; i <= num_li; i++) {
            $(".nav li:eq(" + i + ")").click({ id: i }, function(e) {
                ...
                $(".nav li:eq(" + e.data.id + ")").css("background-color", "#00b7c0") //被點擊到的游標變色，前面的selector用this也可以
                n = e.data.id + 1
            })
        }
